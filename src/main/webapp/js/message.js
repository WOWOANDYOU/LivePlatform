$(document).ready(function(){
	debugger
	var msgData = JSON.parse(sessionStorage.getItem('msgData'));
	console.log(msgData);
	if(msgData.info=='false'){
		layer.msg('查询失败，请稍后再试！',{icon:5});
		return;
	}
	
	var goodInfo = msgData.object;
	...
	var $html = $("<div class='row'>" +
					"<div class='col-lg-10' style='border:solid 1px #ccc;margin:10px auto;border-radius:4px;'>" +
						"<div class='col-lg-12' style='margin-top: 10px;'>"+
        					"<img alt='photo' style='border-radius:2px;' src='"+goodInfo.goodUser.userPhotoPath+"' width='28px' height='28px'>"+
        					"<b style='color:#444;margin-left:5px;'>"+goodInfo.goodUser.userName+"</b>"+
        				"</div>"+
						...
						"<div class='col-lg-12' style='margin-bottom: 10px;margin-top: 10px;'>"+
							"<div class='col-lg-3 readComments' onclick='clickDownComment(this,&quot;"+goodInfo.goodId+"&quot;,&quot;"+goodInfo.goodUserId+"&quot;)'>"+
